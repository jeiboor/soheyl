...
local function check_member(cb_extra, success, result)
   ...
   for k,v in pairs(result.members) do
      ...
      if member_id ~= our_id then
          ...
          return send_large_msg(receiver, 'شما يه مدير گروه ارتقا يافتيد.')
      end
    end
end
...
local function automodadd(msg)
  ...
  if msg.action.type == 'chat_created' then
      ...
      save_data(_config.moderation.data, data)
      return 'گروه اضافه گرديد و @ '..username..' مدير شد!'
   end
end
...
local function promote(receiver, member_username, member_id)
  ...
  if data[group]['moderators'][tostring(member_id)] then
    return send_large_msg(receiver, member_username..' از قبل مدير بوده است!.')
    end
...
local function demote(receiver, member_username, member_id)
  ...
  save_data(_config.moderation.data, data)
  return send_large_msg(receiver, '@'..member_username..' غضو عادي شد.')
end
...
local function admin_promote(receiver, member_username, member_id)  
  ...
  if data['admins'][tostring(member_id)] then
    return send_large_msg(receiver, member_username..' از قبل مدير بود.')
  end
...
local function admin_demote(receiver, member_username, member_id)
  ...
  return send_large_msg(receiver, 'مدير '..member_username..' از ادميني صلب شد.')
end
...
local function username_id(cb_extra, success, result)
   ...
   local text = 'اين فرد @'..member..' در گروه نيست.'
   for k,v in pairs(result.members) do
